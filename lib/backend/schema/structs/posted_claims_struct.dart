...
class PostedClaimsStruct extends BaseStruct {
  PostedClaimsStruct({
    String? policyNumber,
  ...
  static PostedClaimsStruct fromMap(Map<String, dynamic> data) =>
      PostedClaimsStruct(
  ...
  static PostedClaimsStruct? maybeFromMap(dynamic data) => data is Map
      ? PostedClaimsStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static PostedClaimsStruct fromSerializableMap(Map<String, dynamic> data) =>
      PostedClaimsStruct(
  ...
  @override
  String toString() => 'PostedClaimsStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is PostedClaimsStruct &&
...
PostedClaimsStruct createPostedClaimsStruct({
  String? policyNumber,
  String? policyHolderName,
  String? employeeId,
  String? email,
