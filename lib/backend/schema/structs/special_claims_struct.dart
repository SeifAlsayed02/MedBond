...
class SpecialClaimsStruct extends BaseStruct {
  SpecialClaimsStruct({
    String? policyNumber,
  ...
  static SpecialClaimsStruct fromMap(Map<String, dynamic> data) =>
      SpecialClaimsStruct(
  ...
  static SpecialClaimsStruct? maybeFromMap(dynamic data) => data is Map
      ? SpecialClaimsStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static SpecialClaimsStruct fromSerializableMap(Map<String, dynamic> data) =>
      SpecialClaimsStruct(
  ...
  @override
  String toString() => 'SpecialClaimsStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is SpecialClaimsStruct &&
...
SpecialClaimsStruct createSpecialClaimsStruct({
  String? policyNumber,
  String? policyHolderName,
  String? employeeId,
  String? email,
