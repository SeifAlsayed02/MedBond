...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ProviderFinderLandingPageWidget.routeName,
          path: ProviderFinderLandingPageWidget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'MyPolicies')
              : MyPoliciesWidget(),
        ),
        FFRoute(
          name: PolicyDocumentsWidget.routeName,
          path: PolicyDocumentsWidget.routePath,
